...
mixin _$Ingredient {
  ...
  List<InventoryItem> get stock => throw _privateConstructorUsedError;
...
class _$IngredientImpl implements _Ingredient {
  const _$IngredientImpl(
      ...
      final List<InventoryItem> stock = const []})
      : _stock = stock;
  ...
  final List<InventoryItem> _stock;
  @override
  @JsonKey()
  List<InventoryItem> get stock {
  ...
  @override
  String toString() {
    return 'Ingredient(id: $id, name: $name, unit: $unit, currentStock: $currentStock, minLevel: $minLevel, costPerUnit: $costPerUnit, stock: $stock)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, unit, currentStock,
      minLevel, costPerUnit, const DeepCollectionEquality().hash(_stock));
...
abstract class _Ingredient implements Ingredient {
  const factory _Ingredient(
      ...
      final double minLevel,
      final double costPerUnit,
      final List<InventoryItem> stock}) = _$IngredientImpl;
